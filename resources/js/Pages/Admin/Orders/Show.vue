    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div
                    class="p-4 sm:p-8 bg-white shadow sm:rounded-lg grid grid-cols-2 gap-4"
                >
                    <div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr v-for="item in order.items" :key="item.id">
                                ...
                                <td
                                    class="py-4 text-sm text-gray-900 text-center"
                                >
                                    {{ item.quantity }}
                                </td>
                                <td
                                    class="py-4 text-sm text-gray-900 text-right"
                                >
                                    {{ item.price }} ₽
                                </td>
                                <td
                                    class="py-4 text-sm font-bold text-gray-900 text-right"
                                >
                                    {{
