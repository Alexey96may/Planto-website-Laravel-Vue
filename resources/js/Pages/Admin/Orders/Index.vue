        ...
        >
            ...
            <div class="relative flex h-full flex-col justify-between space-y-6">
                <div class="flex items-start justify-between">
                    ...
                    >
                        <span class="mr-1.5 h-1 w-1 animate-pulse rounded-full bg-current"></span>
                        {{ order.status }}
                    </span>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1">
                        <p class="text-[9px] font-black uppercase tracking-widest text-zinc-600">
                            Timeline
                        </p>
