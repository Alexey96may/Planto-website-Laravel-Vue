        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
                ...
                <p class="text-gray-500 text-sm mb-4">
                    Управление ассортиментом ({{ stats.products_count }} шт.)
                </p>
            ...
            >
                ...
                <h2 class="text-xl font-bold mb-2">Пользователи</h2>
                <p class="text-gray-500 text-sm mb-4">
                    Список клиентов и права доступа ({{ stats.users_count }})
                </p>
            ...
            >
                ...
                <h2 class="text-xl font-bold mb-2">Настройки</h2>
                <p class="text-gray-500 text-sm mb-4">
                    Телефон, email и общая информация
                </p>
